...
## Deployment
- [Mainnet](./deployment/deployment-mainnet.json)
- [Goerli](./deployment/deployment-mainnet.json)

## Metadata
- [Mainnet](./metadata/metadata-mainnet.json)
- [Goerli](./metadata/metadata-goerli.json)

## Gelato Tasks (Mainnet)
